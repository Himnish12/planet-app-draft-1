            ...
            <View>
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                 Mercury's Distance from Sun -{'57910006'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                Venus'Distance from Sun -{'108199995'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'12104'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                Earth's Distance from Sun -{'149599951'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'12756'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                Mars'Distance from Sun -{'227939920'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'6779'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
               Jupiter's Distance from Sun -{'778330257'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'133,708'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                 Saturn'sDistance from Sun -{'1429400028'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'120536'}
              ...
              <Text
                style={[styles.cardText, { marginTop: 20, marginLeft: 50 }]}>
                 Uranus' Distance from Sun -{'2870989228'}
                {item.close_approach_data[0].close_approach_date_full}
              </Text>
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>
                Diameter (KM) -{'50724'}
